...
updated: 2026-03-13T10:35:00Z
---

## Current Test

number: 1
name: Store to Semantic Memory
expected: |
  Run memblocks_store_semantic with plain text (e.g., "I love coding in Python"). Tool should extract facts using PS1, resolve any conflicts with PS2, and store to semantic memory. Returns JSON with success message and semantic fact count.
